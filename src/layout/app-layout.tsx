...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Event Team', path: '/event-teams', entity: 'event_team', service: AccessServiceEnum.PROJECT, icon: FiBox },
  {
    name: 'Event Vendor',
    path: '/event-vendors',
    entity: 'event_vendor',
  ...
  { name: 'Vendor', path: '/vendors', entity: 'vendor', service: AccessServiceEnum.PROJECT, icon: FiShoppingCart },
